...
<template>
    <div>
        ...
        <div class="content" v-if="!isLoading">
            ...
            <TabView>
                <TabPanel header="Connection Settings">
                    <Zeroconf />

                </TabPanel>
                <TabPanel header="Organizational Structure">

                </TabPanel>
                <TabPanel header="Security Managenent">
...
.content {
    ...
    flex-grow: 1;
    margin-top: 80px;
    /* Dodanie marginesu, aby nie było zakryte przez TopBar */
}
